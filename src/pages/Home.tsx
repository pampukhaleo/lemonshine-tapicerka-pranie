          ...
          <div className="relative z-10 container mx-auto px-4 py-16 md:py-24">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button
                  size="lg"
                  className="bg-lemon-400 hover:bg-lemon-500 text-foreground font-bold text-lg px-12 py-6 shadow-none border border-lemon-400 hover-lift font-[Poppins]"
                  asChild
                >
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="bg-card/80 backdrop-blur-sm border-2 border-mint-600 text-foreground hover:bg-card font-bold text-lg px-12 py-6 hover-lift font-[Poppins]"
                  asChild
                >
