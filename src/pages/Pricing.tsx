  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-20">
        ...
        <CleaningPricing showHeading={false} className="pt-0" />
              ...
              <div className="grid grid-cols-3 gap-2 md:flex md:flex-wrap md:justify-center md:gap-3">
                {tabs.map((tab) => (
                  <button
                    ...
                    className={`min-w-0 rounded-full px-3 py-2.5 text-xs font-semibold transition-all sm:text-sm md:px-6 md:py-3 ${
                      activeTab === tab.id
