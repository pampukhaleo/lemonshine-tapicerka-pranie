...
const WindowHero = () => {
  ...
  return (
    <section className="py-20 md:py-28 min-h-[520px] md:min-h-[620px] flex items-center relative overflow-hidden bg-gradient-to-r from-lemon-200 via-mint-200 to-mint-100">
      <div
